...
This project has been forked from Skylee, all the credits of this bot go to their devs.
...
This file should be placed in your `saber` folder, alongside the `__main__.py` file . 
...
```
from saber.sample_config import Config
